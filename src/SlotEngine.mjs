...
const GAMES = {
  candy: {
    ...
    W: 6, H: 5, minCluster: 5, maxWinX: 5000, payScale: 2.46,
    ...
    scatter: { id: "SC", emoji: "🍭", chance: 0.03, count: 4, regular: 10, super: 14, retrig: 3, retrigAdd: 5, payX: { 4: 3, 5: 5, 6: 100 } },
  ...
  olympus: {
    ...
    W: 6, H: 5, minCluster: 5, maxWinX: 5000, payScale: 2.09,
    ...
    scatter: { id: "SC", emoji: "⚡", chance: 0.028, count: 4, regular: 12, super: 16, retrig: 3, retrigAdd: 5, payX: { 4: 3, 5: 5, 6: 100 } },
  ...
  bandit: {
    ...
    W: 5, H: 5, minCluster: 5, maxWinX: 5000, payScale: 0.88,
    ...
    scatter: { id: "SC", emoji: "⭐", chance: 0.032, count: 3, regular: 10, super: 14, retrig: 3, retrigAdd: 4, payX: { 3: 3, 4: 10, 5: 50 } },
